import {
  ...
  const SocialLink = (props: NavigationLink) => {
    ...
    const navLinks = props.fields?.data?.datasource?.children?.results;
      // For pulling the Navigation links
      const list = navLinks.map((element, index) => (
      ...
      return (
        <div className='header'>
          {/* Topbar Start */}
          <div className="container-fluid bg-light p-0 wow fadeIn top-navigation" data-wow-delay="0.1s">
              <div className="row gx-0 d-none d-lg-flex">
                  <div className="col-lg-7 px-5 text-start">
                      <div className="h-100 d-inline-flex align-items-center py-4 me-4">
                          <small className="fa fa-map-marker-alt text-primary me-2"></small>
                          <small>
                            <Text field={props.fields.data.datasource.Address} />
                          </small>
                      </div>
                      <div className="h-100 d-inline-flex align-items-center py-4">
          ...
          <nav className="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
              <a href="/" className="navbar-brand d-flex align-items-center px-4 px-lg-5">
                  <h1 className="m-0 text-primary logo"><i className="far fa-hospital me-3"></i>Klinik</h1>
              </a>
              ...
              <div className="collapse navbar-collapse" id="navbarCollapse">
                  ...
                  <a href="" className="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block apt-link">Appointment<i className="fa fa-arrow-right ms-3"></i></a>
              </div>
          </nav>
          {/* Navbar End */}
        </div>
